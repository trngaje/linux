...
static const struct hdmi_timings hdmi_conf_1280x768p60 = {
	.core = {
		.h_blank = {0x90, 0x01}, /* h_blank */
		.v2_blank = {0x1B, 0x03}, /* v_total */
		.v1_blank = {0x1B, 0x00}, /* v_blank */
		.v_line = {0x1B, 0x03}, /* v_total */
		.h_line = {0x90, 0x06}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x3E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xC6, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x90, 0x06, /* h_fsz */ /* htotal */
		0x90, 0x01, 0x00, 0x05, /* hact */ /* hblank / hdisp */
		0x1B, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x1B, 0x00, 0x00, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_960p60 = {
	.core = {
		.h_blank = {0x08, 0x02},
		.v2_blank = {0xe8, 0x03},
		.v1_blank = {0x28, 0x00},
		...
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x5e, 0x00},
		.h_sync_end = {0xce, 0x00},
		.v_sync_line_bef_2 = {0x04, 0x00},
		.v_sync_line_bef_1 = {0x01, 0x00},
		.v_sync_line_aft_2 = {0xff, 0x1f},
		.v_sync_line_aft_1 = {0xff, 0x1f},
		.v_sync_line_aft_pxl_2 = {0xff, 0x1f},
		.v_sync_line_aft_pxl_1 = {0xff, 0x1f},
	...
	.tg = {
		0x00, /* cmd */
		0x08, 0x07, /* h_fsz */
		0x08, 0x02, 0x00, 0x05, /* hact */
		0xe8, 0x03, /* v_fsz */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x28, 0x00, 0xc0, 0x33, /* vact */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x7b, 0x04, /* vact_st3 */
		0xae, 0x06, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_900p60 = {
	.core = {
		.h_blank = {0xa0, 0x00},
		.v2_blank = {0x9e, 0x03},
		.v1_blank = {0x1a, 0x00},
		...
		.vsync_pol = {0x01},
		.int_pro_mode = {0x00},
		.v_blank_f0 = {0xff, 0x1f},
		.v_blank_f1 = {0xff, 0x1f},
		.h_sync_start = {0x2e, 0x00},
		.h_sync_end = {0x4e, 0x00},
	...
	.tg = {
		0x00, /* cmd */
		0x40, 0x06, /* h_fsz */
		0xa0, 0x00, 0xa0, 0x05, /* hact */
		0x9e, 0x03, /* v_fsz */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x1a, 0x00, 0x84, 0x33, /* vact */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x7b, 0x04, /* vact_st3 */
		0xae, 0x06, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1400x1050p60 = {
	.core = {
		.h_blank = {0xE0, 0x01}, /* h_blank */
		.v2_blank = {0x3A, 0x04}, /* v_total */
		.v1_blank = {0x20, 0x00}, /* v_blank */
		.v_line = {0x3A, 0x04}, /* v_total */
		.h_line = {0x58, 0x07}, /* h_total */
		.hsync_pol = {0x01}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x56, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xEE, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x0E, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x02, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x58, 0x07, /* h_fsz */ /* htotal */
		0xE0, 0x01, 0x78, 0x05, /* hact */ /* hblank / hdisp */
		0x3A, 0x04, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x20, 0x00, 0x1A, 0x04, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1024p60 = {
	.core = {
		.h_blank = {0x98, 0x01},
		.v2_blank = {0x2a, 0x04},
		.v1_blank = {0x2a, 0x00},
	...
	.tg = {
		0x00, /* cmd */
		0x98, 0x06, /* h_fsz */
		0x98, 0x01, 0x00, 0x05, /* hact */
		0x2a, 0x04, /* v_fsz */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x2a, 0x00, 0x00, 0x04, /* vact */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x7b, 0x04, /* vact_st3 */
		0xae, 0x06, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1360x768p60 = {
	.core = {
		.h_blank = {0xA0, 0x01}, /* h_blank */
		.v2_blank = {0x1B, 0x03}, /* v_total */
		.v1_blank = {0x1B, 0x00}, /* v_blank */
		.v_line = {0x1B, 0x03}, /* v_total */
		.h_line = {0xF0, 0x06}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x3E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xCE, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0xF0, 0x06, /* h_fsz */ /* htotal */
		0xA0, 0x01, 0x50, 0x05, /* hact */ /* hblank / hdisp */
		0x1B, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x1B, 0x00, 0x00, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
...
static const struct hdmi_timings hdmi_conf_1600x900p60 = {
	.core = {
		.h_blank = {0x10, 0x02}, /* h_blank */
		.v2_blank = {0xA4, 0x03}, /* v_total */
		.v1_blank = {0x20, 0x00}, /* v_blank */
		.v_line = {0xA4, 0x03}, /* v_total */
		.h_line = {0x50, 0x08}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x5E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x06, 0x01}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x03, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x50, 0x08, /* h_fsz */ /* htotal */
		0x10, 0x02, 0x40, 0x06, /* hact */ /* hblank / hdisp */
		0xA4, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x20, 0x00, 0x84, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1600x1200p60 = {
	.core = {
		.h_blank = {0x30, 0x02}, /* h_blank */
		.v2_blank = {0xE2, 0x04}, /* v_total */
		.v1_blank = {0x32, 0x00}, /* v_blank */
		.v_line = {0xE2, 0x04}, /* v_total */
		.h_line = {0x70, 0x08}, /* h_total */
		.hsync_pol = {0x01}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x3E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xFE, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x70, 0x08, /* h_fsz */ /* htotal */
		0x30, 0x02, 0x40, 0x06, /* hact */ /* hblank / hdisp */
		0xE2, 0x04, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x32, 0x00, 0xB0, 0x04, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1792x1344p60 = {
	.core = {
		.h_blank = {0x90, 0x02}, /* h_blank */
		.v2_blank = {0x72, 0x05}, /* v_total */
		.v1_blank = {0x32, 0x00}, /* v_blank */
		.v_line = {0x72, 0x05}, /* v_total */
		.h_line = {0x90, 0x09}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x7E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x46, 0x01}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x90, 0x09, /* h_fsz */ /* htotal */
		0x90, 0x02, 0x00, 0x07, /* hact */ /* hblank / hdisp */
		0x72, 0x05, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x32, 0x00, 0x40, 0x05, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1920x800p60 = {
	.core = {
		.h_blank = {0x60, 0x02}, /* h_blank */
		.v2_blank = {0x3C, 0x03}, /* v_total */
		.v1_blank = {0x1C, 0x00}, /* v_blank */
		.v_line = {0x3C, 0x03}, /* v_total */
		.h_line = {0xE0, 0x09}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x66, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x2E, 0x01}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0xE0, 0x09, /* h_fsz */ /* htotal */
		0x60, 0x02, 0x80, 0x07, /* hact */ /* hblank / hdisp */
		0x3C, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x1C, 0x00, 0x20, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1920x1200p60 = {
	.core = {
		.h_blank = {0xA0, 0x00}, /* h_blank */
		.v2_blank = {0xD3, 0x04}, /* v_total */
		.v1_blank = {0x23, 0x00}, /* v_blank */
		.v_line = {0xD3, 0x04}, /* v_total */
		.h_line = {0x20, 0x08}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x00}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x2E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x4E, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x08, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x02, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x20, 0x08, /* h_fsz */ /* htotal */
		0xA0, 0x00, 0x80, 0x07, /* hact */ /* hblank / hdisp */
		0xD3, 0x04, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x23, 0x00, 0xB0, 0x04, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1200x1920p60 = {
	.core = {
		.h_blank = {0x77, 0x00}, /* h_blank */
		.v2_blank = {0x99, 0x07}, /* v_total */
		.v1_blank = {0x19, 0x00}, /* v_blank */
		.v_line = {0x99, 0x07}, /* v_total */
		.h_line = {0x27, 0x05}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x00}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x3A, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x44, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x07, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x05, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x27, 0x05, /* h_fsz */ /* htotal */
		0x77, 0x00, 0xB0, 0x04, /* hact */ /* hblank / hdisp */
		0x99, 0x07, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x19, 0x00, 0x80, 0x07, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_600p60 = {
	.core = {
		.h_blank = {0x00, 0x01},
		.v2_blank = {0x74, 0x02},
		.v1_blank = {0x1c, 0x00},
		...
		.h_sync_end = {0xa6, 0x00},
		.v_sync_line_bef_2 = {0x05, 0x00},
		.v_sync_line_bef_1 = {0x01, 0x00},
		.v_sync_line_aft_2 = {0xff, 0x1f},
		.v_sync_line_aft_1 = {0xff, 0x1f},
		.v_sync_line_aft_pxl_2 = {0xff, 0x1f},
...
static const struct hdmi_timings hdmi_conf_848x480p60 = {
	.core = {
		.h_blank = {0xD0, 0x00}, /* h_blank */
		.v2_blank = {0xF1, 0x01}, /* v_total */
		.v1_blank = {0x11, 0x00}, /* v_blank */
		.v_line = {0xF1, 0x01}, /* v_total */
		.h_line = {0x20, 0x04}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x0E, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x66, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x20, 0x04, /* h_fsz */ /* htotal */
		0xD0, 0x00, 0x50, 0x03, /* hact */ /* hblank / hdisp */
		0xF1, 0x01, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x11, 0x00, 0xE0, 0x01, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1024x600p60 = {
	.core = {
		.h_blank = {0x40, 0x01}, /* h_blank */
		.v2_blank = {0x71, 0x02}, /* v_total */
		.v1_blank = {0x19, 0x00}, /* v_blank */
		.v_line = {0x71, 0x02}, /* v_total */
		.h_line = {0x40, 0x05}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x16, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x9E, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x40, 0x05, /* h_fsz */ /* htotal */
		0x40, 0x01, 0x00, 0x04, /* hact */ /* hblank / hdisp */
		0x71, 0x02, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x19, 0x00, 0x58, 0x02, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_768p60 = {
	...
	.tg = {
		0x00, /* cmd */
		0x40, 0x05, /* h_fsz */
		0x40, 0x01, 0x00, 0x04, /* hact */
		0x26, 0x03, /* v_fsz */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x26, 0x00, 0x00, 0x03, /* vact */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x7b, 0x04, /* vact_st3 */
		0xae, 0x06, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1152x864p75 = {
	.core = {
		.h_blank = {0x90, 0x01}, /* h_blank */
		.v2_blank = {0x86, 0x03}, /* v_total */
		.v1_blank = {0x26, 0x00}, /* v_blank */
		.v_line = {0x86, 0x03}, /* v_total */
		.h_line = {0x10, 0x06}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x01}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x46, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xC6, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x04, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x01, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x10, 0x06, /* h_fsz */ /* htotal */
		0x90, 0x01, 0x80, 0x04, /* hact */ /* hblank / hdisp */
		0x86, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x26, 0x00, 0x60, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_1080p23_976 = {
	.core = {
		.h_blank = {0x3E, 0x03}, /* h_blank */
		.v2_blank = {0x65, 0x04}, /* v_total */
		.v1_blank = {0x2D, 0x00}, /* v_blank */
		.v_line = {0x65, 0x04}, /* v_total */
		.h_line = {0xBE, 0x0A}, /* h_total */
		.hsync_pol = {0x1}, /* HSync */
		.vsync_pol = {0x1}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x7C, 0x02}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xA8, 0x02}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x09, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x04, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0xBE, 0x0A, /* h_fsz */ /* htotal */
		0x3E, 0x03, 0x80, 0x07, /* hact */ /* hblank / hdisp */
		0x65, 0x04, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x2D, 0x00, 0x38, 0x04, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_480p60 = {
	.core = {
		.h_blank = {0xa0, 0x00},
		.v2_blank = {0x0d, 0x02},
		.v1_blank = {0x2d, 0x00},
		...
		.h_sync_end = {0x6e, 0x00},
		.v_sync_line_bef_2 = {0x0c, 0x00},
		.v_sync_line_bef_1 = {0x0a, 0x00},
		.v_sync_line_aft_2 = {0xff, 0x1f},
		.v_sync_line_aft_1 = {0xff, 0x1f},
		.v_sync_line_aft_pxl_2 = {0xff, 0x1f},
		.v_sync_line_aft_pxl_1 = {0xff, 0x1f},
...
static const struct hdmi_timings hdmi_conf_480x272p60 = {
	.core = {
		.h_blank = {0x18, 0x01},  /* h_blank = 120+120+40 = 280 = 0x118 */
		.v2_blank = {0x3E, 0x02}, /* v_total = 272+62+200+40 = 574 = 0x23E */
		.v1_blank = {0x2E, 0x01}, /* v_blank = 62+200+40 = 302 = 0x12E */
		.v_line = {0x3E, 0x02},   /* v_total */
		.h_line = {0xF8, 0x02},   /* h_total = 480+120+120+40 = 760 = 0x2F8 */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x00}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x76, 0x00}, /* hsyncstart - 2 = 120-2 = 118 = 0x76 */
		.h_sync_end = {0x9E, 0x00},   /* hsyncend - 2 = 120+40-2 = 158 = 0x9E */
		.v_sync_line_bef_2 = {0x66, 0x00}, /* vsyncend = 62+40 = 102 = 0x66 */
		.v_sync_line_bef_1 = {0x3E, 0x00}, /* vsyncstart = 62 = 0x3E */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0xF8, 0x02, /* htotal */
		0x18, 0x01, 0xE0, 0x01, /* hblank, hact */ 
		0x3E, 0x02, /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync(?) */
		0x2E, 0x01, 0x10, 0x01, /* vblank, vact */
		0x33, 0x02, /* field_chg(?) */
		0x48, 0x02, /* vact_st2(?) */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_480x320p60 = {
	.core = {
		.h_blank = {0x40, 0x01}, /* h_blank */
		.v2_blank = {0x0D, 0x02}, /* v_total */
		.v1_blank = {0xCD, 0x0}, /* v_blank */
		.v_line = {0x0D, 0x02}, /* v_total */
		.h_line = {0x20, 0x03}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x00}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x76, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0xDA, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x0F, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x08, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x20, 0x03, /* h_fsz */ /* htotal */
		0x40, 0x01, 0xE0, 0x01, /* hact */ /* hblank / hdisp */
		0x0D, 0x02, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0xCD, 0x00, 0x40, 0x01, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
static const struct hdmi_timings hdmi_conf_480x800p60 = {
	.core = {
		.h_blank = {0x80, 0x00}, /* h_blank */
		.v2_blank = {0x4D, 0x03}, /* v_total */
		.v1_blank = {0x2D, 0x00}, /* v_blank */
		.v_line = {0x4D, 0x03}, /* v_total */
		.h_line = {0x60, 0x02}, /* h_total */
		.hsync_pol = {0x00}, /* HSync */
		.vsync_pol = {0x00}, /* VSync */
		.int_pro_mode = {0x00}, /* progress 0 , interlace 1 */
		.v_blank_f0 = {0xff, 0xff},
		.v_blank_f1 = {0xff, 0xff},
		.h_sync_start = {0x26, 0x00}, /* (hsyncstart - hdisp - 2)*/
		.h_sync_end = {0x56, 0x00}, /* (hsyncend - hdisp - 2) */
		.v_sync_line_bef_2 = {0x0D, 0x00}, /* vsyncend - vdisp */
		.v_sync_line_bef_1 = {0x0A, 0x00}, /* vsyncstart - vdisp */
		.v_sync_line_aft_2 = {0xff, 0xff},
		.v_sync_line_aft_1 = {0xff, 0xff},
		.v_sync_line_aft_pxl_2 = {0xff, 0xff},
		.v_sync_line_aft_pxl_1 = {0xff, 0xff},
	...
	.tg = {
		0x00, /* cmd */
		0x60, 0x02, /* h_fsz */ /* htotal */
		0x80, 0x00, 0xE0, 0x01, /* hact */ /* hblank / hdisp */
		0x4D, 0x03, /* v_fsz */ /* vtotal */
		0x01, 0x00, 0x33, 0x02, /* vsync */
		0x2D, 0x00, 0x20, 0x03, /* vact */ /* vblank / vdisp */
		0x33, 0x02, /* field_chg */
		0x48, 0x02, /* vact_st2 */
		0x00, 0x00, /* vact_st3 */
		0x00, 0x00, /* vact_st4 */
...
const struct hdmi_conf hdmi_conf[] = {
	{ V4L2_DV_BT_CEA_480X272P60,		&hdmi_conf_480x272p60,		&info_2d },
	{ V4L2_DV_BT_CEA_480X320P60,		&hdmi_conf_480x320p60,		&info_2d },
	...
	{ V4L2_DV_BT_CEA_480X800P60,		&hdmi_conf_480x800p60,		&info_2d },
	{ V4L2_DV_BT_CEA_800X480P60,		&hdmi_conf_800x480p60,		&info_2d },
	{ V4L2_DV_BT_DMT_800X600P60,		&hdmi_conf_600p60,		&info_2d },
	{ V4L2_DV_BT_DMT_848X480P60,		&hdmi_conf_848x480p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1024X600P60,		&hdmi_conf_1024x600p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1024X768P60,		&hdmi_conf_768p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1152X864P75,		&hdmi_conf_1152x864p75,		&info_2d },
	{ V4L2_DV_BT_CEA_1280X720P50,		&hdmi_conf_720p50,		&info_2d },
	{ V4L2_DV_BT_CEA_1280X720P60,		&hdmi_conf_720p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1280X768P60,		&hdmi_conf_1280x768p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1280X800P60_RB,	&hdmi_conf_800p59,		&info_2d },
	{ V4L2_DV_BT_DMT_1280X960P60,		&hdmi_conf_960p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1440X900P60,		&hdmi_conf_900p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1400X1050P60,		&hdmi_conf_1400x1050p60,	&info_2d },
	{ V4L2_DV_BT_DMT_1280X1024P60,		&hdmi_conf_1024p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1360X768P60_2,		&hdmi_conf_1360x768p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1600X900P60,		&hdmi_conf_1600x900p60,		&info_2d },
	{ V4L2_DV_BT_DMT_1600X1200P60,		&hdmi_conf_1600x1200p60,	&info_2d },
	{ V4L2_DV_BT_DMT_1792X1344P60,		&hdmi_conf_1792x1344p60,	&info_2d },
	{ V4L2_DV_BT_DMT_1920X800P60,		&hdmi_conf_1920x800p60,		&info_2d },
	{ V4L2_DV_BT_CEA_1920X1080I50,		&hdmi_conf_1080i50,		&info_2d },
	{ V4L2_DV_BT_CEA_1920X1080I60,		&hdmi_conf_1080i60,		&info_2d },
	{ V4L2_DV_BT_CEA_1920X1080P23_976,	&hdmi_conf_1080p23_976,		&info_2d },
	...
	{ V4L2_DV_BT_DMT_1920X1200P60_RB,	&hdmi_conf_1920x1200p60,	&info_2d },
	{ V4L2_DV_BT_DMT_1200X1920P60,		&hdmi_conf_1200x1920p60,	&info_2d },
...
int hdmi_conf_apply(struct hdmi_device *hdmi_dev)
{
	...
	if (is_ip_ver_5a || is_ip_ver_5s || is_ip_ver_5s2) {
		...
		ret = v4l2_subdev_call(hdmi_dev->phy_sd, video, s_dv_timings, &timings);
		if (ret) {
